...
export default function HeroSection() {
	return (
		<section
			className="relative lg:max-h-screen min-h-fit md:py-16 sm:px-8 lg:px-4"
			style={{
				backgroundImage:
					"url('https://res.cloudinary.com/degrggosz/image/upload/v1749568717/7af20210-0bc7-4f9d-bbbb-c1028ba7c381_rvbnfj.jpg')",
				backgroundSize: "cover",
				backgroundPosition: "center",
				backgroundRepeat: "no-repeat",
			}}>
			<InViewUp>
				<div className=" mx-auto flex flex-col lg:flex-row items-center px-6 justify-between w-full bg-transparent">
					{/* Left Content */}
					<div className="text-center lg:w-3/5 bg-transparent">
						<InViewUp>
							<motion.h2
						...
						<InViewUp>
							<motion.p
								...
								ideas into sleek, functional, and scalable web applications.
								From front-end aesthetics to robust back-end solutions, we do it
								all!
							</motion.p>
						</InViewUp>
						<InViewUp>
